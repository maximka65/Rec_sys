...
class MainRecommender:
    ...
    def __init__(self, data, n_factors=10, regularization=0.001, iterations=15, num_threads=4,                     weighting=True):
        self.data = data
    ...
    def fit(user_item_matrix, n_factors=20, regularization=0.001, iterations=15, num_threads=4):
        ...
        model = AlternatingLeastSquares(factors=n_factors,
                                        regularization=regularization,
                                        iterations=iterations,
                                        num_threads=num_threads, random_state=0)
    ...
    def get_popularity_recommendation(self, n=5):
    ...
    def predict_rank(self, user, N=5):
        return get_als_recommendations(user, N=5)